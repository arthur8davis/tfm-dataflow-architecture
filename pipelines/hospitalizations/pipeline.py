"""
Pipeline específico para el schema HOSPITALIZATIONS
"""
import sys
import yaml
import argparse
...
class HospitalizationsPipeline:
    """Pipeline para procesar datos de HOSPITALIZATIONS"""

    def __init__(self, config_path: str = None, mode: str = "streaming"):
        """
        Inicializa el pipeline de hospitalizations
...
def main():
    """Función principal"""
    parser = argparse.ArgumentParser(description='Pipeline HOSPITALIZATIONS - COVID-19')
    parser.add_argument(
        '--mode',
        type=str,
