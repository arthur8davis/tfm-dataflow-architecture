"""
Script de ingesta para el schema DEMISES
"""
import os
import sys
import yaml
...
class DemisesIngestion:
    """Ingesta de datos para el schema DEMISES"""
...
def main():
    """Función principal"""
    parser = argparse.ArgumentParser(description='Ingesta de datos para DEMISES')
